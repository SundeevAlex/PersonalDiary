...
class Diary(models.Model):
    ...
    image_cover = models.ImageField(
        upload_to="diary/photo/cover", verbose_name="Фото обложки", help_text="Загрузите фото обложки", **NULLABLE
    )
    content = models.TextField(
        verbose_name="Содержание", help_text="Введите текст вашего дневника"
    )
    image = models.ImageField(
        upload_to="diary/photo", verbose_name="Фото события", help_text="Загрузите фото события", **NULLABLE
    )
